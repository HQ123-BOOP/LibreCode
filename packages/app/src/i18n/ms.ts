export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi LibreCode",
  ...
  "desktop.menu.ariaLabel": "Menu LibreCode",
  ...
  "desktop.recovery.loadFailed": "LibreCode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap LibreCode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "LibreCode tidak memberi respons",
  ...
  "desktop.wsl.error.installopencode": "Pemasangan LibreCode gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.opencodeMissing": "LibreCode tidak dipasang dalam distro ini",
  "desktop.wsl.error.opencodeCannotRun": "LibreCode dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini LibreCode selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh LibreCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam LibreCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam LibreCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam LibreCode.",
  ...
  "dialog.server.description": "Tukar pelayan LibreCode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingopencode": "Sedang menyemak LibreCode...",
  "wsl.onboarding.checkingopencodeIn": "Sedang menyemak LibreCode dalam {{distro}}...",
  "wsl.onboarding.updatingopencode": "Sedang mengemas kini LibreCode...",
  "wsl.onboarding.updatingopencodeIn": "Sedang mengemas kini LibreCode dalam {{distro}}...",
  "wsl.onboarding.updateopencodeIn": "Kemas kini LibreCode dalam {{distro}}.",
  "wsl.onboarding.updateopencode": "Kemas kini LibreCode",
  "wsl.onboarding.opencodeReadyIn": "LibreCode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "LibreCode sedia digunakan.",
  "wsl.onboarding.installopencodeIn": "Pasang LibreCode dalam {{distro}}.",
  "wsl.onboarding.installopencode": "Pasang LibreCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum LibreCode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "LibreCode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula LibreCode.",
  ...
  "help.tabs.introduction": "LibreCode Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu LibreCode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan LibreCode",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, LibreCode belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "LibreCode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan LibreCode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk LibreCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa LibreCode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada LibreCode mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema LibreCode.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila LibreCode dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini LibreCode.",
