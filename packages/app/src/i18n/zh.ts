...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "LibreCode 加载失败",
  "desktop.recovery.terminated": "LibreCode 窗口意外终止",
  "desktop.recovery.unresponsive": "LibreCode 未响应",
  ...
  "desktop.wsl.error.installopencode": "LibreCode 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.opencodeMissing": "此发行版中未安装 LibreCode",
  "desktop.wsl.error.opencodeCannotRun": "已安装 LibreCode，但无法运行",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 LibreCode",
  "desktop.wsl.error.updateVersion":
    "LibreCode 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 LibreCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 LibreCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 LibreCode 中使用 {{provider}} 模型。",
  ...
  "wsl.onboarding.checkingopencode": "正在检查 LibreCode...",
  "wsl.onboarding.checkingopencodeIn": "正在检查 {{distro}} 中的 LibreCode...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 LibreCode 已就绪。",
  "wsl.onboarding.opencodeReady": "LibreCode 已就绪。",
  "wsl.onboarding.installopencodeIn": "在 {{distro}} 中安装 LibreCode。",
  "wsl.onboarding.installopencode": "安装 LibreCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 LibreCode",
  ...
  "wsl.onboarding.wslNotInstalled.description": "LibreCode 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "LibreCode 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 LibreCode。",
  ...
  "help.tabs.introduction": "LibreCode Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
