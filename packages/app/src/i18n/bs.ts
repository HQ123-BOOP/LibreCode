export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za LibreCode",
  ...
  "desktop.recovery.loadFailed": "LibreCode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor LibreCode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "LibreCode ne reaguje",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje LibreCode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi LibreCode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "LibreCode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori LibreCode.",
  ...
  "help.tabs.introduction": "LibreCode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
