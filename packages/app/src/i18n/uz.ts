export const dict = {
  ...
  "desktop.menu.documentation": "LibreCode hujjatlari",
  ...
  "desktop.menu.ariaLabel": "LibreCode menyusi",
  ...
  "desktop.recovery.loadFailed": "LibreCode yuklanmadi",
  "desktop.recovery.terminated": "LibreCode oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "LibreCode javob bermayapti",
  ...
  "desktop.wsl.error.installopencode": "LibreCode oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.opencodeMissing": "LibreCode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.opencodeCannotRun": "LibreCode o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "LibreCode yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "LibreCode tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va LibreCode’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va LibreCode da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va LibreCode da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi LibreCode serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingopencode": "LibreCode tekshirilmoqda...",
  "wsl.onboarding.checkingopencodeIn": "LibreCode {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingopencode": "LibreCode yangilanmoqda...",
  "wsl.onboarding.updatingopencodeIn": "LibreCode {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateopencodeIn": "LibreCode-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateopencode": "LibreCode-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "LibreCode {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "LibreCode tayyor.",
  "wsl.onboarding.installopencodeIn": "LibreCode-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installopencode": "LibreCode-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "LibreCode WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "LibreCode WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra LibreCode-ni qayta oching.",
  ...
  "help.tabs.introduction": "LibreCode Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "LibreCode ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida LibreCode jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, LibreCode hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "LibreCode bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi LibreCode serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "LibreCode uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "LibreCode qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "LibreCode tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "LibreCode mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "LibreCode ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz LibreCode oxirgi versiyasini ishga tushiryapsiz.",
