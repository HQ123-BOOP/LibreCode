export const dict = {
  ...
  "desktop.menu.documentation": "LibreCode-dokumentation",
  ...
  "desktop.menu.ariaLabel": "LibreCode-meny",
  ...
  "desktop.recovery.loadFailed": "LibreCode kunde inte läsas in",
  "desktop.recovery.terminated": "LibreCode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "LibreCode svarar inte",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "LibreCode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av LibreCode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i LibreCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i LibreCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i LibreCode.",
  ...
  "dialog.server.description": "Växla vilken LibreCode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan LibreCode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "LibreCode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan LibreCode igen.",
  ...
  "help.tabs.introduction": "LibreCode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av LibreCode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till LibreCode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, LibreCode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "LibreCode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör LibreCode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för LibreCode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur LibreCode ser ut på din enhet",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när LibreCode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av LibreCode.",
