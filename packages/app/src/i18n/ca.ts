export const dict = {
  ...
  "desktop.menu.documentation": "LibreCode Documentació",
  ...
  "desktop.menu.ariaLabel": "menú LibreCode.",
  ...
  "desktop.recovery.loadFailed": "LibreCode no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra LibreCode s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "LibreCode no respon",
  ...
  "desktop.wsl.error.installopencode": "La instal·lació de LibreCode ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.opencodeMissing": "LibreCode no està instal·lat en aquesta distribució",
  "desktop.wsl.error.opencodeCannotRun": "LibreCode està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "LibreCode actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per LibreCode",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a LibreCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "LibreCode Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a LibreCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a LibreCode.",
  ...
  "dialog.server.description": "Canvia a quin LibreCode servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingopencode": "S'està comprovant LibreCode...",
  "wsl.onboarding.checkingopencodeIn": "S'està registrant LibreCode a {{distro}}...",
  "wsl.onboarding.updatingopencode": "S'està actualitzant LibreCode...",
  "wsl.onboarding.updatingopencodeIn": "S'està actualitzant LibreCode a {{distro}}...",
  "wsl.onboarding.updateopencodeIn": "Actualitza LibreCode a {{distro}}.",
  "wsl.onboarding.updateopencode": "Actualització LibreCode",
  "wsl.onboarding.opencodeReadyIn": "LibreCode està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "LibreCode està llest.",
  "wsl.onboarding.installopencodeIn": "Instal·leu LibreCode a {{distro}}.",
  "wsl.onboarding.installopencode": "Instal·la LibreCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que LibreCode pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "LibreCode no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir LibreCode.",
  ...
  "help.tabs.introduction": "LibreCode L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de LibreCode ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip LibreCode.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que LibreCode encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "LibreCode inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "LibreCode Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor LibreCode dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a LibreCode",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu LibreCode al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si LibreCode segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de LibreCode.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï LibreCode.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de LibreCode.",
