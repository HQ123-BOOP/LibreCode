export const dict = {
  ...
  "desktop.menu.documentation": "LibreCode دستاویزات",
  ...
  "desktop.menu.ariaLabel": "LibreCode مینو",
  ...
  "desktop.recovery.loadFailed": "LibreCode لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "LibreCode ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "LibreCode جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "LibreCode کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.opencodeMissing": "اس ڈسٹری بیوشن میں LibreCode انسٹال نہیں ہے",
  "desktop.wsl.error.opencodeCannotRun": "LibreCode انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں LibreCode انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "LibreCode کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.model.unpaid.freeModels.title": "LibreCode کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور LibreCode میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور LibreCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور LibreCode میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس LibreCode سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "LibreCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں LibreCode چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "LibreCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں LibreCode کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں LibreCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "LibreCode کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "LibreCode {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "LibreCode تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں LibreCode انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "LibreCode انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ LibreCode WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "LibreCode اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر LibreCode کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "LibreCode Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "LibreCode ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم LibreCode ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، LibreCode ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "LibreCode میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "LibreCode ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر LibreCode سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "LibreCode کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر LibreCode کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا LibreCode سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "LibreCode کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "LibreCode لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ LibreCode کا تازہ ترین ورژن چلا رہے ہیں۔",
