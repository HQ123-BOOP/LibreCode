export const dict = {
  ...
  "desktop.menu.documentation": "LibreCode Dokumentacija",
  ...
  "desktop.menu.ariaLabel": "LibreCode meni",
  ...
  "desktop.recovery.loadFailed": "LibreCode ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno LibreCode se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "LibreCode se ne odziva",
  ...
  "desktop.wsl.error.installopencode": "Namestitev LibreCode ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.opencodeMissing": "LibreCode ni nameščen v tej distribuciji",
  "desktop.wsl.error.opencodeCannotRun": "LibreCode je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev LibreCode je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja LibreCode",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v LibreCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "LibreCode Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v LibreCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v LibreCode.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom LibreCode se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingopencode": "Preverjanje LibreCode ...",
  "wsl.onboarding.checkingopencodeIn": "Preverjanje LibreCode v {{distro}} ...",
  "wsl.onboarding.updatingopencode": "Posodabljanje LibreCode ...",
  "wsl.onboarding.updatingopencodeIn": "Posodabljanje LibreCode v {{distro}} ...",
  "wsl.onboarding.updateopencodeIn": "Posodobite LibreCode v {{distro}}.",
  "wsl.onboarding.updateopencode": "Posodobite LibreCode",
  "wsl.onboarding.opencodeReadyIn": "LibreCode je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "LibreCode je pripravljen.",
  "wsl.onboarding.installopencodeIn": "Namestite LibreCode v {{distro}}.",
  "wsl.onboarding.installopencode": "Namestite LibreCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko LibreCode doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "LibreCode ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite LibreCode.",
  ...
  "help.tabs.introduction": "LibreCode Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica LibreCode ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi LibreCode",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, LibreCode še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "LibreCode vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik LibreCode znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za LibreCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako LibreCode izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali LibreCode sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo LibreCode.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene LibreCode",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico LibreCode.",
