export const dict = {
  ...
  "desktop.recovery.loadFailed": "LibreCode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "LibreCode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "LibreCode ei vasta",
  ...
  "desktop.wsl.error.installopencode": "LibreCode installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.opencodeMissing": "LibreCode pole sellesse distrosse installitud",
  "desktop.wsl.error.opencodeCannotRun": "LibreCode on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "LibreCode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub LibreCode",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid LibreCode'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises LibreCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises LibreCode.",
  ...
  "dialog.server.description": "Lülitage, millise LibreCode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingopencode": "LibreCode kontrollimine...",
  "wsl.onboarding.checkingopencodeIn": "LibreCode kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingopencode": "LibreCode värskendamine...",
  "wsl.onboarding.updatingopencodeIn": "LibreCode värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateopencodeIn": "Värskenda LibreCode jaotises {{distro}}.",
  "wsl.onboarding.updateopencode": "Värskenda LibreCode",
  "wsl.onboarding.opencodeReadyIn": "LibreCode on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "LibreCode on valmis.",
  "wsl.onboarding.installopencodeIn": "Installige LibreCode asukohta {{distro}}.",
  "wsl.onboarding.installopencode": "Installige LibreCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui LibreCode saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "LibreCode ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti LibreCode.",
  ...
  "help.tabs.introduction": "LibreCode Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse LibreCode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast LibreCode meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, LibreCode ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "LibreCode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "LibreCode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage LibreCode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke LibreCode kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas LibreCode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas LibreCode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas LibreCode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui LibreCode käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse LibreCode uusimat versiooni.",
