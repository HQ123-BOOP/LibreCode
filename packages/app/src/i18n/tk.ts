export const dict = {
  ...
  "desktop.menu.documentation": "LibreCode Resminamalar",
  ...
  "desktop.menu.ariaLabel": "LibreCode menýusy",
  ...
  "desktop.recovery.loadFailed": "LibreCode ýükläp bilmedi",
  "desktop.recovery.terminated": "LibreCode penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "LibreCode jogap berenok",
  ...
  "desktop.wsl.error.installopencode": "LibreCode gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.opencodeMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.opencodeCannotRun": "LibreCode guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "LibreCode täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "LibreCode tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we LibreCode-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini LibreCode-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini LibreCode-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.server.description": "Bu programmanyň haýsy LibreCode serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingopencode": "LibreCode barlamak ...",
  "wsl.onboarding.checkingopencodeIn": "{{distro}} içinde LibreCode barlanýar...",
  "wsl.onboarding.updatingopencode": "LibreCode täzelenmek ...",
  "wsl.onboarding.updatingopencodeIn": "{{distro}}-de LibreCode täzelenmek ...",
  "wsl.onboarding.updateopencodeIn": "LibreCode-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateopencode": "LibreCode täzeläň",
  "wsl.onboarding.opencodeReadyIn": "LibreCode {{distro}}-de taýýar.",
  "wsl.onboarding.opencodeReady": "LibreCode taýýar.",
  "wsl.onboarding.installopencodeIn": "{{distro}}-de LibreCode guruň.",
  "wsl.onboarding.installopencode": "LibreCode guruň",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) LibreCode WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "LibreCode bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra LibreCode açyň.",
  ...
  "help.tabs.introduction": "LibreCode Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin LibreCode ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy LibreCode toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, LibreCode entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "LibreCode mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "LibreCode serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "LibreCode üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "LibreCode enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "LibreCode ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "LibreCode-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "LibreCode işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "LibreCode-iň iň soňky wersiýasyny işleýärsiňiz.",
