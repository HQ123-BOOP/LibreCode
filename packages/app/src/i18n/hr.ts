...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "LibreCode se nije uspio učitati",
  "Prozor aplikacije LibreCode neočekivano je zatvoren",
  "LibreCode ne reagira",
  ...
  "Instalacija aplikacije LibreCode nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "LibreCode nije instaliran u ovoj distribuciji",
  "LibreCode je instaliran, ali se ne može pokrenuti",
  "LibreCode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije LibreCode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi LibreCode",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u LibreCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "LibreCode Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u LibreCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u LibreCode.",
  ...
  "dialog.server.description": "Promijenite na koji se LibreCode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingopencodeIn": "Provjera LibreCode u {{distro}}...",
  "wsl.onboarding.updatingopencode": "Ažuriranje LibreCode...",
  "wsl.onboarding.updatingopencodeIn": "Ažuriranje LibreCode u {{distro}}...",
  "wsl.onboarding.updateopencodeIn": "Ažurirajte LibreCode u {{distro}}.",
  "wsl.onboarding.updateopencode": "Ažurirajte LibreCode",
  "wsl.onboarding.opencodeReadyIn": "LibreCode je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "LibreCode je spreman.",
  "wsl.onboarding.installopencodeIn": "Instalirajte LibreCode u {{distro}}.",
  "wsl.onboarding.installopencode": "Instalirajte LibreCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što LibreCode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "LibreCode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite LibreCode.",
  ...
  "help.tabs.introduction": "Radna površina LibreCode sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija LibreCode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku LibreCode timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, LibreCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "LibreCode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "LibreCode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite LibreCode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za LibreCode",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako LibreCode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li LibreCode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je LibreCode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se LibreCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju LibreCode.",
