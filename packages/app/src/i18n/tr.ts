...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "LibreCode yüklenemedi",
  "desktop.recovery.terminated": "LibreCode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "LibreCode yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "LibreCode kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.opencodeMissing": "LibreCode bu dağıtımda kurulu değil",
  "desktop.wsl.error.opencodeCannotRun": "LibreCode kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "LibreCode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve LibreCode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak LibreCode'da {{provider}} modellerini kullanın.",
  ...
  "wsl.onboarding.checkingOpencode": "LibreCode kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde LibreCode kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "LibreCode güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde LibreCode güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki LibreCode'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "LibreCode'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde LibreCode hazır.",
  "wsl.onboarding.opencodeReady": "LibreCode hazır.",
  "wsl.onboarding.installOpencodeIn": "LibreCode'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "LibreCode'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "LibreCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "LibreCode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından LibreCode'u tekrar açın.",
  ...
  "help.tabs.introduction": "LibreCode Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Lütfen bu hatayı LibreCode ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: LibreCode henüz MCP kimlik doğrulamasını desteklemiyor.',
