export const dict = {
  ...
  "desktop.menu.documentation": "LibreCode Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "LibreCode μενού",
  ...
  "desktop.recovery.loadFailed": "LibreCode απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "LibreCode το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "LibreCode δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installopencode": "LibreCode η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "LibreCode η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από LibreCode",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο LibreCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο LibreCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο LibreCode.",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή LibreCode συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingopencode": "Έλεγχος LibreCode...",
  "wsl.onboarding.checkingopencodeIn": "Έλεγχος LibreCode σε {{distro}}...",
  "wsl.onboarding.updatingopencode": "Ενημέρωση LibreCode...",
  "wsl.onboarding.updatingopencodeIn": "Ενημέρωση LibreCode σε {{distro}}...",
  "wsl.onboarding.updateopencodeIn": "Ενημέρωση LibreCode σε {{distro}}.",
  "wsl.onboarding.updateopencode": "Ενημέρωση LibreCode",
  "wsl.onboarding.opencodeReadyIn": "LibreCode είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "LibreCode είναι έτοιμο.",
  "wsl.onboarding.installopencodeIn": "Εγκατάσταση του LibreCode στο {{distro}}.",
  "wsl.onboarding.installopencode": "Εγκατάσταση LibreCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο LibreCode να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "LibreCode δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το LibreCode.",
  ...
  "help.tabs.introduction": "LibreCode Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του LibreCode ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα LibreCode",
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το LibreCode δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "LibreCode περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "LibreCode Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή LibreCode μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το LibreCode",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του LibreCode στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το LibreCode ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το LibreCode.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του LibreCode",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του LibreCode.",
