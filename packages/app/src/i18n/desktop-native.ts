...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "LibreCode failed to load",
  "desktop.recovery.terminated": "LibreCode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "LibreCode is not responding",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "LibreCode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
