export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل LibreCode",
  "desktop.recovery.terminated": "توقفت نافذة LibreCode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "LibreCode لا يستجيب",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث LibreCode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في LibreCode.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن LibreCode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على LibreCode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح LibreCode.",
  ...
  "help.tabs.introduction": "أصبح LibreCode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من LibreCode ({{version}}) للتثبيت.",
