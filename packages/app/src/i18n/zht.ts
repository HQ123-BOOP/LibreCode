...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "LibreCode 載入失敗",
  "desktop.recovery.terminated": "LibreCode 視窗意外終止",
  "desktop.recovery.unresponsive": "LibreCode 沒有回應",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 LibreCode",
  "desktop.wsl.error.updateVersion":
    "LibreCode 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 LibreCode",
  ...
  "wsl.onboarding.wslUnavailable.description": "LibreCode 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 LibreCode。",
  ...
  "help.tabs.introduction": "LibreCode Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：LibreCode 尚不支援 MCP 驗證。",
