export const dict = {
  ...
  "wsl.onboarding.checkingopencode": "LibreCode 확인 중...",
  "wsl.onboarding.checkingopencodeIn": "{{distro}}에서 LibreCode 확인 중...",
  "wsl.onboarding.updatingopencode": "LibreCode 업데이트 중...",
  "wsl.onboarding.updatingopencodeIn": "{{distro}}에서 LibreCode 업데이트 중...",
  "wsl.onboarding.updateopencodeIn": "{{distro}}에서 LibreCode를 업데이트하세요.",
  "wsl.onboarding.updateopencode": "LibreCode 업데이트",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}에서 LibreCode를 사용할 준비가 되었습니다.",
  "wsl.onboarding.opencodeReady": "LibreCode가 준비되었습니다.",
  "wsl.onboarding.installopencodeIn": "{{distro}}에 LibreCode를 설치하세요.",
  "wsl.onboarding.installopencode": "LibreCode 설치",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "LibreCode에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "LibreCode에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 LibreCode를 다시 여세요.",
  ...
  "help.tabs.introduction": "이제 LibreCode Desktop은 탭을 중심으로 구성됩니다.",
  "help.tabs.sessions":
  ...
  "desktop.recovery.loadFailed": "LibreCode를 불러오지 못했습니다",
  "desktop.recovery.terminated": "LibreCode 윈도우가 예기치 않게 종료되었습니다",
  "desktop.recovery.unresponsive": "LibreCode가 응답하지 않습니다",
  ...
  "desktop.wsl.error.installopencode": "LibreCode 설치 실패",
  "desktop.wsl.error.alreadyAdded": "{{distro}} 배포판은 이미 추가되었습니다",
  "desktop.wsl.error.opencodeMissing": "이 배포판에 LibreCode가 설치되어 있지 않습니다",
  "desktop.wsl.error.opencodeCannotRun": "LibreCode가 설치되어 있지만 실행할 수 없습니다",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}에 LibreCode가 설치되어 있지 않습니다",
  "desktop.wsl.error.updateVersion":
    "LibreCode 업데이트가 완료되었지만 {{distro}}에서 여전히 {{installed}} 버전으로 표시됩니다. 예상 버전: {{expected}}",
