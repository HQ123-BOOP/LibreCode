export const dict = {
  ...
  "desktop.menu.documentation": "LibreCode Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka LibreCode",
  ...
  "desktop.recovery.loadFailed": "LibreCode se nepodařilo načíst",
  "desktop.recovery.terminated": "LibreCode okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "LibreCode nereaguje",
  ...
  "desktop.wsl.error.installopencode": "LibreCode instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.opencodeMissing": "LibreCode není v této distribuci nainstalováno",
  "desktop.wsl.error.opencodeCannotRun": "LibreCode je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "LibreCode aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezplatné modely poskytované LibreCode",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v LibreCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "LibreCode Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v LibreCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v LibreCode.",
  ...
  "dialog.server.description": "Přepněte, ke kterému LibreCode serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingopencode": "Kontrola LibreCode...",
  "wsl.onboarding.checkingopencodeIn": "Kontrola LibreCode v {{distro}}...",
  "wsl.onboarding.updatingopencode": "Aktualizace LibreCode...",
  "wsl.onboarding.updatingopencodeIn": "Aktualizace LibreCode v {{distro}}...",
  "wsl.onboarding.updateopencodeIn": "Aktualizace LibreCode v {{distro}}.",
  "wsl.onboarding.updateopencode": "Aktualizovat LibreCode",
  "wsl.onboarding.opencodeReadyIn": "LibreCode je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "LibreCode je připraven.",
  "wsl.onboarding.installopencodeIn": "Nainstalujte LibreCode do {{distro}}.",
  "wsl.onboarding.installopencode": "Instalovat LibreCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než LibreCode může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "LibreCode nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete LibreCode.",
  ...
  "help.tabs.introduction": "LibreCode Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze LibreCode ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu LibreCode",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: LibreCode zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "LibreCode obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server LibreCode uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro LibreCode",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled LibreCode na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude LibreCode následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma LibreCode.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění LibreCode",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi LibreCode.",
