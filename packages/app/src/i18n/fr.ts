export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'LibreCode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'LibreCode",
  "desktop.recovery.terminated": "La fenêtre LibreCode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "LibreCode ne répond pas",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'LibreCode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'LibreCode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "LibreCode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez LibreCode.",
  ...
  "help.tabs.introduction": "LibreCode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
