export const dict = {
  ...
  "desktop.menu.documentation": "LibreCode Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "LibreCode մենյու",
  ...
  "desktop.recovery.loadFailed": "LibreCode չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "LibreCode պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "LibreCode-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installopencode": "LibreCode տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.opencodeMissing": "LibreCode-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.opencodeCannotRun": "LibreCode-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "LibreCode թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են LibreCode",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և LibreCode-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և LibreCode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և LibreCode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ LibreCode սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingopencode": "Ստուգում է LibreCode...",
  "wsl.onboarding.checkingopencodeIn": "Ստուգում է LibreCode-ը {{distro}}...",
  "wsl.onboarding.updatingopencode": "Թարմացվում է LibreCode...",
  "wsl.onboarding.updatingopencodeIn": "Թարմացվում է LibreCode-ը {{distro}}...",
  "wsl.onboarding.updateopencodeIn": "Թարմացնել LibreCode-ը {{distro}}-ում։",
  "wsl.onboarding.updateopencode": "Թարմացնել LibreCode",
  "wsl.onboarding.opencodeReadyIn": "LibreCode պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.opencodeReady": "LibreCode պատրաստ է։",
  "wsl.onboarding.installopencodeIn": "Տեղադրեք LibreCode-ը {{distro}}-ում։",
  "wsl.onboarding.installopencode": "Տեղադրեք LibreCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի LibreCode-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "LibreCode-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք LibreCode։",
  ...
  "help.tabs.introduction": "LibreCode Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "LibreCode-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին LibreCode թիմին",
  ...
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ LibreCode-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "LibreCode ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք LibreCode սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն LibreCode",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է LibreCode տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ LibreCode-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է LibreCode-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ LibreCode-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք LibreCode-ի վերջին տարբերակը։",
