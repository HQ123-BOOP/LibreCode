export const dict = {
  ...
  "desktop.recovery.loadFailed": "LibreCode መጫን አልቻለም",
  "desktop.recovery.terminated": "LibreCode መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "LibreCode ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installopencode": "LibreCodeመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "LibreCode ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በLibreCode",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በLibreCode ይጠቀሙ።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በLibreCode ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በLibreCode ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው LibreCode አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingopencode": "መፈተሽ LibreCode...",
  "wsl.onboarding.checkingopencodeIn": "LibreCodeን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingopencode": "በማዘመን ላይ LibreCode...",
  "wsl.onboarding.updatingopencodeIn": "በማዘመን ላይ LibreCode በ{{distro}}...",
  "wsl.onboarding.updateopencodeIn": "አዘምን LibreCode በ{{distro}}።",
  "wsl.onboarding.updateopencode": "አዘምን LibreCode",
  "wsl.onboarding.opencodeReadyIn": "LibreCode በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "LibreCode ዝግጁ ነው።",
  "wsl.onboarding.installopencodeIn": "መጫን LibreCode በ{{distro}} ውስጥ።",
  "wsl.onboarding.installopencode": "ጫን LibreCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCodeአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) LibreCode WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "LibreCode በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ LibreCode።",
  ...
  "help.tabs.introduction": "LibreCode ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የLibreCode ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለLibreCode ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ LibreCode እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "LibreCode ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "LibreCode ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የLibreCode አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለLibreCode",
  ...
  "settings.general.row.appearance.description": "LibreCodeበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "LibreCode ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "LibreCode ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "LibreCode ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የLibreCode እትም እያሄዱ ነው።",
