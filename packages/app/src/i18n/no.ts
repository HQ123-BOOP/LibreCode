...
export const dict = {
  ...
  "desktop.menu.documentation": "LibreCode-dokumentasjon",
  ...
  "desktop.recovery.loadFailed": "LibreCode kunne ikke lastes inn",
  "desktop.recovery.terminated": "LibreCode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "LibreCode svarer ikke",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av LibreCode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i LibreCode.",
  ...
  "settings.general.row.colorScheme.description":
    "Velg om LibreCode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i LibreCode.",
  ...
  "settings.updates.toast.latest.title": "LibreCode er oppdatert",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før LibreCode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "LibreCode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter LibreCode på nytt.",
  ...
  "help.tabs.introduction": "LibreCode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
