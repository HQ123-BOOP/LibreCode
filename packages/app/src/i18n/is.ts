...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða LibreCode",
  "LibreCode-glugganum var óvænt lokað",
  "LibreCode svarar ekki",
  ...
  "Uppsetning LibreCode mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "LibreCode er ekki uppsett í þessari dreifingu",
  "LibreCode er uppsett en ekki var hægt að keyra það",
  "LibreCode er ekki uppsett í {{distro}}",
  "Uppfærslu LibreCode lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá LibreCode",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í LibreCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í LibreCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í LibreCode.",
  ...
  "dialog.server.description": "Skiptu um hvaða LibreCode miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingopencode": "Athugar LibreCode...",
  "wsl.onboarding.checkingopencodeIn": "Athugar LibreCode í {{distro}}...",
  "wsl.onboarding.updatingopencode": "Uppfærir LibreCode...",
  "wsl.onboarding.updatingopencodeIn": "Uppfærir LibreCode í {{distro}}...",
  "wsl.onboarding.updateopencodeIn": "Uppfærðu LibreCode í {{distro}}.",
  "wsl.onboarding.updateopencode": "Uppfærðu LibreCode",
  "wsl.onboarding.opencodeReadyIn": "LibreCode er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "LibreCode er tilbúinn.",
  "wsl.onboarding.installopencodeIn": "Settu upp LibreCode í {{distro}}.",
  "wsl.onboarding.installopencode": "Settu upp LibreCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en LibreCode getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "LibreCode gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan LibreCode aftur.",
  ...
  "help.tabs.introduction": "LibreCode Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af LibreCode ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til LibreCode teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, LibreCode styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "LibreCode inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "LibreCode skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu LibreCode netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir LibreCode",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig LibreCode lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort LibreCode fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig LibreCode er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar LibreCode ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af LibreCode.",
