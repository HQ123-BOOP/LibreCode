...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "LibreCode įkelti nepavyko",
  "LibreCode langas netikėtai užsidarė",
  "LibreCode neatsako",
  ...
  "LibreCode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "LibreCode šiame distributyve neįdiegtas",
  "LibreCode įdiegtas, bet jo paleisti nepavyko",
  "LibreCode neįdiegtas distributyve {{distro}}",
  "LibreCode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami LibreCode modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje LibreCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius LibreCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius LibreCode.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio LibreCode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingopencode": "Tikrinama LibreCode...",
  "wsl.onboarding.checkingopencodeIn": "Tikrinama LibreCode {{distro}}...",
  "wsl.onboarding.updatingopencode": "Atnaujinamas LibreCode...",
  "wsl.onboarding.updatingopencodeIn": "Atnaujinamas LibreCode {{distro}}...",
  "wsl.onboarding.updateopencodeIn": "Atnaujinkite LibreCode {{distro}}.",
  "wsl.onboarding.updateopencode": "Atnaujinkite LibreCode",
  "wsl.onboarding.opencodeReadyIn": "LibreCode yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "LibreCode yra paruoštas.",
  "wsl.onboarding.installopencodeIn": "Įdiekite LibreCode į {{distro}}.",
  "wsl.onboarding.installopencode": "Įdiekite LibreCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad LibreCode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "LibreCode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite LibreCode.",
  ...
  "help.tabs.introduction": "LibreCode Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują LibreCode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą LibreCode komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad LibreCode dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "LibreCode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "LibreCode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite LibreCode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite LibreCode ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip LibreCode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar LibreCode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite LibreCode temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas LibreCode",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią LibreCode versiją.",
