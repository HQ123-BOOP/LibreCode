export const dict = {
  ...
  "desktop.recovery.loadFailed": "LibreCodeを読み込めませんでした",
  "desktop.recovery.terminated": "LibreCodeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "LibreCodeが応答していません",
  ...
  "desktop.wsl.error.installopencode": "LibreCodeのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.opencodeMissing": "このディストリビューションにはLibreCodeがインストールされていません",
  "desktop.wsl.error.opencodeCannotRun": "LibreCodeはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはLibreCodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "LibreCodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "wsl.onboarding.checkingopencode": "LibreCodeを確認中...",
  "wsl.onboarding.checkingopencodeIn": "{{distro}}内のLibreCodeを確認中...",
  "wsl.onboarding.updatingopencode": "LibreCodeを更新中...",
  "wsl.onboarding.updatingopencodeIn": "{{distro}}内のLibreCodeを更新中...",
  "wsl.onboarding.updateopencodeIn": "{{distro}}内のLibreCodeを更新してください。",
  "wsl.onboarding.updateopencode": "LibreCodeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のLibreCodeの準備ができました。",
  "wsl.onboarding.opencodeReady": "LibreCodeの準備ができました。",
  "wsl.onboarding.installopencodeIn": "{{distro}}にLibreCodeをインストールしてください。",
  "wsl.onboarding.installopencode": "LibreCodeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "LibreCodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、LibreCodeをもう一度開いてください。",
