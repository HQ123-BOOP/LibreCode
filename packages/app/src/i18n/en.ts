...
export const dict = {
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before LibreCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "LibreCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen LibreCode.",
  ...
  "help.tabs.introduction": "LibreCode Desktop is now built around tabs.",
  "help.tabs.sessions":
