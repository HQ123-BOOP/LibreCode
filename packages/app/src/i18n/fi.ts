export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "LibreCoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja LibreCodessa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja LibreCodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja LibreCodessa.",
  ...
  "dialog.server.description": "Vaihda LibreCode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingopencode": "Tarkistetaan LibreCodea...",
  "wsl.onboarding.checkingopencodeIn": "Tarkistetaan LibreCodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingopencode": "Päivitetään LibreCodea...",
  "wsl.onboarding.updatingopencodeIn": "Päivitetään LibreCodea kohteessa {{distro}}...",
  "wsl.onboarding.updateopencodeIn": "Päivitä LibreCode jakelussa {{distro}}.",
  "wsl.onboarding.updateopencode": "Päivitä LibreCode",
  "wsl.onboarding.opencodeReadyIn": "LibreCode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "LibreCode on valmis.",
  "wsl.onboarding.installopencodeIn": "Asenna LibreCode jakeluun {{distro}}.",
  "wsl.onboarding.installopencode": "Asenna LibreCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin LibreCode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "LibreCode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten LibreCode uudelleen.",
  ...
  "toast.update.description": "LibreCoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä LibreCode-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että LibreCode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "LibreCode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita LibreCode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda LibreCoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä LibreCode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö LibreCode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta LibreCoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun LibreCode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät LibreCoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "LibreCode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "LibreCode-valikko",
  ...
  "desktop.recovery.loadFailed": "LibreCoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "LibreCode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "LibreCode ei vastaa",
  ...
  "desktop.wsl.error.installopencode": "LibreCoden asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.opencodeMissing": "LibreCodea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.opencodeCannotRun": "LibreCode on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.opencodeNotInstalled": "LibreCodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "LibreCoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "LibreCode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
