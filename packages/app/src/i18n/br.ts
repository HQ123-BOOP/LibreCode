export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do LibreCode",
  ...
  "desktop.menu.ariaLabel": "Menu do LibreCode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o LibreCode",
  "desktop.recovery.terminated": "A janela do LibreCode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O LibreCode não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do LibreCode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.opencodeMissing": "O LibreCode não está instalado nesta distribuição",
  "desktop.wsl.error.opencodeCannotRun": "O LibreCode está instalado, mas não pôde ser executado",
  "desktop.wsl.error.opencodeNotInstalled": "O LibreCode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do LibreCode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o LibreCode...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o LibreCode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o LibreCode...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o LibreCode em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o LibreCode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o LibreCode",
  "wsl.onboarding.opencodeReadyIn": "O LibreCode está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O LibreCode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o LibreCode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o LibreCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o LibreCode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O LibreCode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o LibreCode novamente.",
  ...
  "help.tabs.introduction": "Agora, o LibreCode Desktop é organizado em abas.",
  "help.tabs.sessions":
