export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de LibreCode",
  ...
  "desktop.menu.ariaLabel": "Menú de LibreCode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar LibreCode",
  "desktop.recovery.terminated": "La ventana de LibreCode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "LibreCode no responde",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de LibreCode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.server.description": "Cambiar el servidor de LibreCode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que LibreCode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "LibreCode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir LibreCode.",
  ...
  "help.tabs.introduction": "LibreCode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "error.page.report.prefix": "Informa de este error al equipo de LibreCode",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: LibreCode aún no admite la autenticación MCP.',
