export const dict = {
  ...
  "desktop.menu.documentation": "LibreCode-documentatie",
  ...
  "desktop.recovery.loadFailed": "LibreCode kan niet worden geladen",
  "desktop.recovery.terminated": "Het LibreCode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "LibreCode reageert niet",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De LibreCode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door LibreCode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in LibreCode te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in LibreCode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in LibreCode te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke LibreCode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat LibreCode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "LibreCode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens LibreCode opnieuw.",
  ...
  "help.tabs.introduction": "LibreCode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van LibreCode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het LibreCode-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: LibreCode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "LibreCode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de LibreCode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor LibreCode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe LibreCode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of LibreCode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van LibreCode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer LibreCode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "LibreCode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van LibreCode.",
