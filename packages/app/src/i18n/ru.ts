export const dict = {
  ...
  "desktop.menu.documentation": "Документация LibreCode",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить LibreCode",
  "desktop.recovery.terminated": "Окно LibreCode неожиданно завершило работу",
  "desktop.recovery.unresponsive": "LibreCode не отвечает",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление LibreCode завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в LibreCode.",
  ...
  "dialog.server.description": "Выберите сервер LibreCode, к которому подключается приложение.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в LibreCode требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "LibreCode не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте LibreCode.",
  ...
  "help.tabs.introduction": "Теперь работа в LibreCode Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: LibreCode пока не поддерживает MCP-авторизацию.',
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид LibreCode на вашем устройстве",
