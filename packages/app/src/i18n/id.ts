export const dict = {
  ...
  "desktop.recovery.loadFailed": "LibreCode gagal dimuat",
  "desktop.recovery.terminated": "Jendela LibreCode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "LibreCode tidak merespons",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan LibreCode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh LibreCode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di LibreCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di LibreCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di LibreCode.",
  ...
  "dialog.server.description": "Ganti server LibreCode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum LibreCode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "LibreCode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali LibreCode.",
  ...
  "help.tabs.introduction": "LibreCode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru LibreCode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim LibreCode",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: LibreCode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "LibreCode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server LibreCode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk LibreCode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan LibreCode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah LibreCode mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat LibreCode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru LibreCode.",
