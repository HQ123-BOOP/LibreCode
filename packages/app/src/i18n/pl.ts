export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja LibreCode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać LibreCode",
  "desktop.recovery.terminated": "Okno LibreCode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "LibreCode nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować LibreCode",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.opencodeMissing": "Program LibreCode nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.opencodeCannotRun": "Program LibreCode jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja LibreCode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie LibreCode...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie LibreCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie LibreCode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie LibreCode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj LibreCode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj LibreCode",
  "wsl.onboarding.opencodeReadyIn": "LibreCode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "LibreCode jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj LibreCode w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj LibreCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim LibreCode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "LibreCode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz LibreCode.",
  ...
  "help.tabs.introduction": "LibreCode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: LibreCode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer LibreCode wewnątrz WSL w systemie Windows.",
