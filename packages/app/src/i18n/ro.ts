export const dict = {
  ...
  "desktop.menu.documentation": "Documentație LibreCode",
  ...
  "desktop.menu.ariaLabel": "Meniu LibreCode",
  ...
  "desktop.recovery.loadFailed": "LibreCode nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra LibreCode s-a închis neașteptat",
  "desktop.recovery.unresponsive": "LibreCode nu răspunde",
  ...
  "desktop.wsl.error.installopencode": "Instalarea LibreCode a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.opencodeMissing": "LibreCode nu este instalat în această distribuție",
  "desktop.wsl.error.opencodeCannotRun": "LibreCode este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea LibreCode s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de LibreCode",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în LibreCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în LibreCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în LibreCode.",
  ...
  "dialog.server.description": "Schimbă serverul LibreCode la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingopencode": "Se verifică LibreCode...",
  "wsl.onboarding.checkingopencodeIn": "Se verifică LibreCode în {{distro}}...",
  "wsl.onboarding.updatingopencode": "Se actualizează LibreCode...",
  "wsl.onboarding.updatingopencodeIn": "Se actualizează LibreCode în {{distro}}...",
  "wsl.onboarding.updateopencodeIn": "Actualizează LibreCode în {{distro}}.",
  "wsl.onboarding.updateopencode": "Actualizează LibreCode",
  "wsl.onboarding.opencodeReadyIn": "LibreCode este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "LibreCode este gata.",
  "wsl.onboarding.installopencodeIn": "Instalează LibreCode în {{distro}}.",
  "wsl.onboarding.installopencode": "Instalează LibreCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca LibreCode să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "LibreCode nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide LibreCode.",
  ...
  "help.tabs.introduction": "LibreCode Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune LibreCode ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei LibreCode",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, LibreCode nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "LibreCode include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul LibreCode în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru LibreCode",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul LibreCode pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă LibreCode urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema LibreCode.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea LibreCode",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune LibreCode.",
