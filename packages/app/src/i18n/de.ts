...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in LibreCode zu nutzen.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "LibreCode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor LibreCode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "LibreCode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann LibreCode erneut.",
  ...
  "home.providerTip":
    "LibreCode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "settings.updates.toast.latest.title": "LibreCode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von LibreCode wird verwendet.",
  ...
  "desktop.menu.ariaLabel": "LibreCode-Menü",
  ...
  "desktop.recovery.loadFailed": "LibreCode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das LibreCode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "LibreCode reagiert nicht",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "LibreCode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das LibreCode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "LibreCode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
