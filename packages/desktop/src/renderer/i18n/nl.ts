export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van LibreCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van LibreCode is gedownload. Wil je deze installeren en LibreCode opnieuw starten?",
