export const dict = {
  ...
  "desktop.updater.none.message": "LibreCode-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "LibreCode-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'LibreCode' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
