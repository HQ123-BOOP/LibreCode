export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የLibreCode ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከLibreCode ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
