export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av LibreCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av LibreCode har laddats ned. Vill du installera den och starta om programmet?",
