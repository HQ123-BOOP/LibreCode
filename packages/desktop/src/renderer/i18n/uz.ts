export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon LibreCode ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "LibreCodening {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'LibreCode' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
