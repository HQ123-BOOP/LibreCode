export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse LibreCode uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "LibreCode'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „LibreCode” kasutamiseks taaskäivitage terminal.",
